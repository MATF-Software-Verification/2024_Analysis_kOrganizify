...
SyncResponseWindow::SyncResponseWindow(QString friendName, QString title,
  ...
  // connect(ui->le_nameInput, &QLineEdit::textChanged, this,
  // &SyncWindow::onTextEntered); connect(ui->cb_selectHours,
  // QOverload<int>::of(&QComboBox::currentIndexChanged), this,
  // &SyncWindow::onNumberSelected); connect(ui->btn_sync,
  // &QPushButton::clicked, this, &SyncWindow::onSyncButtonClicked);
  connect(ui->btnNo, &QPushButton::clicked, this, &SyncResponseWindow::sendNo);
  connect(ui->btnYes, &QPushButton::clicked, this,
          &SyncResponseWindow::sendYes);
}

SyncResponseWindow::~SyncResponseWindow() { delete ui; }
