...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::MainWindow), m_user(nullptr) {
  ui->setupUi(this);
  ...
  ui->leUsername->setStyleSheet(
      "QLineEdit{color: black; background-color: #B4B19A; }");
  ui->lePassword->setStyleSheet(
      "QLineEdit{color: black; background-color: #B4B19A; }");

  connect(ui->btnLogin, &QPushButton::clicked, this, &MainWindow::loginUser);
  connect(ui->lePassword, &QLineEdit::returnPressed, this,
